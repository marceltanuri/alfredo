...
privatePage = session.post(host+path, data=formData,headers={'Content-Type': 'application/x-www-form-urlencoded'})
print(privatePage)
...
transactionsPage = session.get(host+path+"?"+queryString, allow_redirects=True)
